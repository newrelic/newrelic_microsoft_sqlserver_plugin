...
{
    [AzureSqlQuery("WaitStates.AzureSql.sql", "WaitState/{MetricName}/{WaitType}", QueryName = "Wait States", Enabled = true)]
    [SqlServerQuery("WaitStates.SqlServer.sql", "WaitState/{MetricName}/{WaitType}", QueryName = "Wait States", Enabled = true)]
