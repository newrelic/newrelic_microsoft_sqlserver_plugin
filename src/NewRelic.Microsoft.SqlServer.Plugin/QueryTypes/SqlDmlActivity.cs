...
{
    [AzureSqlQuery("SqlDMLActivity.SqlServerAndAzureSQL.sql", "DMLActivity/{MetricName}", QueryName = "Sql DML Activity", Enabled = true)]
    [SqlServerQuery("SqlDMLActivity.SqlServerAndAzureSQL.sql", "DMLActivity/{MetricName}", QueryName = "Sql DML Activity", Enabled = false)]
